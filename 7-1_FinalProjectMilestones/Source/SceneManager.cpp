...
//Dock 
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-20.0f, 1.5f, 10.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-23.0f, 0.0f, 1.0f);
...
//Dock leg front right
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-17.0f, 0.0f, 1.0f);
...
//Dock leg mid left
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-23.0f, 0.0f, 18.0f);
...
//Dock leg mid right
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-17.0f, 0.0f, 18.0f);
...
//Bobber Base 
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(.25f, 1.0f, 0.25f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.0f, .5f, 0.0f);
...
//Bobber Top 
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.0f, 1.5f, 0.0f);
	...
	SetShaderColor(0.996, 0.769, 0.004, 1);
...
//Life raft
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(3.0f, 3.0f, 4.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.0f, 0.25f, 0.25f);
...
//fishing rod - base
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.20f, 3.0f, 0.25f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-17.0f, 1.5f, 1.0f);
...
//fishing rod - middle
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.15f, 12.0f, 0.25f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-17.0f, 3.5f, -1.0f);
	...
	SetShaderColor(0.043, 0.043, 0.956, 1);
...
//reel
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.50f, 0.50f, 1.75f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-17.0f, 2.5f, -1.0f);
